...
prob_14_03st_vs.txt en este se encuentran las coincidencias de ambas columnas leidas
edos_14_03_sep.txt un archivo con los estados separados por columnas
"""

import numpy as np
data=np.genfromtxt('./Resultados/Rumorosa/2014/estados_graf_2014.csv', delimiter=',')
f0=open('./Resultados/Rumorosa/2014/prob_ruf_14_06_st_vs.txt', 'w')
#f1=open('./Resultados/Rumorosa/mix/prob_mix_06st_fm.txt', 'w')
f2=open('./Resultados/Rumorosa/2014/edos_ruf_14_06_sep.txt', 'w')
f3=open('./Resultados/Rumorosa/2014/p_ruf_coin_14_06_sep.txt', 'w')
vs=data[:,0]
st=data[:,8]
...
f2.close() 
data1=np.genfromtxt('./Resultados/Rumorosa/2014/edos_ruf_14_06_sep.txt', delimiter='\t')   
d1=data1[:,0]
d2=data1[:,1]
d3=data1[:,2]
d4=data1[:,3]
